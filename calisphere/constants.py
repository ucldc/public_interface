...
FACET_FILTER_TYPES = [
    ...
    },
    {
        ...
        'repository_url',
        'filter_transform':
        lambda filterVal: repositoryIdToUrl(filterVal),
        'facet_transform':
        lambda facetVal: getRepositoryData(repository_data=facetVal),
        'filter_display':
        lambda filterVal: repositoryFilterDisplay(filterVal)
    },
    {
        'facet':
        'collection_data',
        ...
        'collection_url',
        'filter_transform':
        lambda filterVal: collectionIdToUrl(filterVal),
        'facet_transform':
        lambda facetVal: getCollectionData(collection_data=facetVal),
        'filter_display':
        lambda filterVal: collectionFilterDisplay(filterVal)
    }
]
