...
urlpatterns = [
    ...
    url(r'^institution/(?P<repository_id>\d*)/$',
        institution_views.repository_collections,
        name='repositoryCollections'),
    url(r'^institution/(?P<repository_id>\d*)/collections/$',
        institution_views.repository_collections,
        name='repositoryCollections'),
    url(r'^institution/(?P<repository_id>\d*)/items/$',
        institution_views.repository_search,
        name='repositorySearch'),

    url(r'^(?P<campus_slug>UC\w{1,2})/$',
        institution_views.campus_collections,
        name='campusCollections'),
    url(r'^(?P<campus_slug>UC\w{1,2})/collections/$',
        institution_views.campus_collections,
        name='campusCollections'),
    url(r'^(?P<campus_slug>UC\w{1,2})/items/$',
        institution_views.campus_search,
        name='campusSearch'),
    url(r'^(?P<campus_slug>UC\w{1,2})/institutions/$',
